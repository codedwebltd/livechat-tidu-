    ...
    <div className="p-4 md:p-6">
      ...
      <div className="bg-white rounded-xl p-4 md:p-6 mb-6 shadow-sm border border-gray-100">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
          ...
          <button className="text-blue-600 hover:bg-blue-50 px-4 py-2 rounded-lg font-medium text-xs md:text-sm whitespace-nowrap self-start md:self-auto transition">
            Complete onboarding
          </button>
        </div>
      </div>
